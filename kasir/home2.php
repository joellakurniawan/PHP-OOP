...
if(isset($_POST['pilihannya'])){
	...
	$sql="SELECT * from mall where nama_mall='$permintaan'";
	$result=mysqli_query($con,$sql);
	$row=mysqli_fetch_array($result);
	$idnya = $row[0];
	$sql="SELECT * from studio WHERE id_mall=$idnya";
	$result=mysqli_query($con,$sql);
...
if(isset($_POST['delete_table'])){
	$sql="DELETE FROM `pegawai` WHERE id_pegawai=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['delete_tableFilm'])){
	$sql="DELETE FROM `film` WHERE id_film=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['delete_tableMall'])){
	$sql="DELETE FROM `mall` WHERE id_mall=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['delete_tableStudio'])){
	$sql="DELETE FROM `studio` WHERE id_studio=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['delete_tableJadwal'])){
	$sql="DELETE FROM `jadwal` WHERE id_jadwal=".$_POST['id']."";
	mysqli_query($con,$sql);
	$sql="DELETE FROM `tiket` WHERE id_jadwal=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['add_table'])){
	$sql="INSERT INTO `pegawai`(`id_pegawai`, `nama_pegawai`, `username_pegawai`, `password_pegawai`, `status_pegawai`) VALUES (NULL,'".$_POST['name']."','".$_POST['username']."','".$_POST['password']."',1)";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['add_tableFilm'])){
	$sql="INSERT INTO `film`(`id_film`, `judul_film`, `deskripsi_film`, `foto_film`) VALUES (NULL,'".$_POST['name']."','".$_POST['username']."','".$_POST['password']."')";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['add_tableMall'])){
	$sql="INSERT INTO `mall`(`id_mall`, `nama_mall`) VALUES (NULL,'".$_POST['name']."')";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['add_tableStudio'])){
	$sql="SELECT * from mall where nama_mall='".$_POST['pilih']."'";
	$result = mysqli_query($con,$sql);
	$row = mysqli_fetch_array($result);
	$sql="INSERT INTO `studio`(`id_studio`,`nama_studio`, `id_mall`) VALUES (NULL,".$_POST['name'].",".$row[0].")";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['add_tableJadwal'])){
	$namamall = $_POST['mall'];
	$sql="SELECT * from mall where nama_mall='$namamall'";
	$result = mysqli_query($con,$sql);
	$row = mysqli_fetch_array($result);
	$a = $row[0];
	$namastudio = $_POST['nama'];
	$sql="SELECT * from studio where nama_studio=$namastudio AND id_mall=$a";
	$result = mysqli_query($con,$sql);
	$row = mysqli_fetch_array($result);
	$idstudio = $row[0];
	$namafilm = $_POST['film'];
	...
	$row = mysqli_fetch_array($result);
	$idfilm = $row[0];
	$sql="INSERT INTO `jadwal`(`id_jadwal`,`tanggal_jadwal`,`jam_jadwal`,`id_studio`,`id_film`, `harga_tiket`) VALUES (NULL,'".$_POST['hari']."','".$_POST['waktu']."',$idstudio,$idfilm,".$_POST['harga'].")";
	mysqli_query($con,$sql);
...
if(isset($_POST['update_table'])){
	$sql="UPDATE `pegawai` SET `nama_pegawai`='".$_POST['name']."',`username_pegawai`='".$_POST['username']."',`password_pegawai`='".$_POST['password']."' WHERE id_pegawai=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['update_tableFilm'])){
	$sql="UPDATE `film` SET `judul_film`='".$_POST['name']."',`deskripsi_film`='".$_POST['username']."',`foto_film`='".$_POST['password']."' WHERE id_film=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['update_tableMall'])){
	$sql="UPDATE `mall` SET `nama_mall`='".$_POST['name']."' WHERE id_mall=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['update_tableStudio'])){
	...
	$result = mysqli_query($con,$sql);
	$row = mysqli_fetch_array($result);
	$sql="UPDATE `studio` SET `nama_studio`=".$_POST['name'].",`id_mall`=".$row[0]." WHERE id_studio=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
if(isset($_POST['update_tableJadwal'])){
	...
	$waktuan = $_POST['waktu'];
	$hargaan = $_POST['harga'];
	$sql="UPDATE `jadwal` SET `tanggal_jadwal`='$harian',`jam_jadwal`='$waktuan',`id_studio`=$idstudio,`id_film`='$idfilm', `harga_tiket`=$hargaan WHERE id_jadwal=".$_POST['id']."";
	mysqli_query($con,$sql);
	exit();
}
